...
def generate_launch_description():
    ...
    lidar_pkg_share = FindPackageShare('urg_node2').find('urg_node2')

    description_launch_file = os.path.join(description_pkg_share, 'launch', 'display.launch.py')
    
    lidar_launch_file = os.path.join(lidar_pkg_share, 'launch', 'urg_node2.launch.py')
    ...
    return LaunchDescription([
        ...
        #Node(
        #   package='can_motor',
        #    executable='motor_sender_node',
        #    name='motor_sender_node'
        #),
        #Node(
        #    package='can_motor',
        #    executable='motor_receiver_node',
        #    name='motor_receiver_node'
        #),
        Node(
            package='ds4_driver',
        ...
        #Node(
        #    package='hfi_a9',
        #    executable='hfi_a9_EKF_node',
        #    name='hfi_a9_EKF_node'
        #),
        Node(
            package='omni_robot',
