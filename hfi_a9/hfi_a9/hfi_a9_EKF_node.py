...
class ImuMagCalibrator(Node):
    def __init__(self):
        ...
        self.mag_sub = Subscriber(self, MagneticField, 'imu/mag')
        
        self.yaw_publisher = self.create_publisher(Vector3Stamped, '/yaw_ekf', 10)
    ...
    def EKF(self):
        ...
        yaw_msg.vector.z = float(self.new_x[0])
